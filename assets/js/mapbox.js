...
const isAccidentFilterVisible =
  window.getComputedStyle(document.getElementById(accidentFilterId)).display !==
  "none";
...
const setSummaryTable = (accidents) => {
  document.getElementById(summaryTableContainerId).innerHTML =
    createSummaryTable(accidents);
};
...
window.fetchData = (e) => {
  ...
  const reqUrl =
    form.action +
    "?" +
    Array.from(new FormData(form), (e) =>
